...
!function(t, i) {
    ...
    e._getItemLayoutPosition = function(t) {
        ...
        for (var h = this.options.horizontalOrder ? "_getHorizontalColPosition" : "_getTopColPosition", n = this[h](e, t), s = {
            ...
            y: n.y
        }, r = n.y + t.size.outerHeight, a = e + n.col, u = n.col; u < a; u++)
            this.colYs[u] = r;
        return s
    }
    ,
    ...
    e._manageStamp = function(t) {
        ...
        for (var u = this._getOption("originTop"), l = (u ? e.top : e.bottom) + o.outerHeight, c = r; c <= a; c++)
...
!function(t) {
    ...
    ;
    var r, a = document.documentElement, c = "string" == typeof a.style.transition ? "transition" : "WebkitTransition", s = c ? 1e3 : 1500;
    i.notify = function(t) {
...
MasonryDocs.hero = function(e) {
    ...
    function t(e) {
        ...
        i.className = "hero__example-link",
        i.href = e.url;
        var r = document.createElement("img");
        r.className = "hero__example-link__img",
        r.src = e.image;
        var m = document.createElement("p");
        return m.className = "hero__example-link__title",
