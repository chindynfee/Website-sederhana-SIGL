    ...
    t(document).on("ready", function() {
        jQuery.fn.extend({
            equalHeights: function(e) {
                ...
                this.setItemsWithInner = function(e, n, i, h) {
                    i ? "auto" == n ? t(e).find(i).height(n) : t(e).find(i).each(function() {
                        ...
                        do {
                            var i = t(i).parent();
                            e -= parseInt(t(i).css("padding-top")),
                            e -= parseInt(t(i).css("padding-bottom"))
                        } while (!t(i).is(h));
                        t(this).height(e)
                    }) : t(e).height(n)
                }
                ...
                return t(e.parent).each(function() {
                    var h = []
                      ...
                      , a = 0
                      , u = this;
                    h = e.parent.length > 1 ? t(this).find(i) : i,
                    n.setItemsWithInner(h, "auto", e.innerItem),
                    t(h).each(function() {
                        var i = t(this).outerWidth(!0)
                          , h = t(this).height();
                        if (i + r > t(u).width() && s.length > 0 && e.perRow)
                            return n.setItemsWithInner(s, a, e.innerItem, u),
                            s = [this],
                            a = h,
                            void (r = i);
                        a < h && (a = h),
                    ...
                    s.length > 0 && (n.setItemsWithInner(s, a, e.innerItem, u),
                    s = [])
                }),
                this
            }
